...
public class DimensionOfMemberResolver extends ParametersCheckingFunctionDefinitionResolver {

	public DimensionOfMemberResolver() {
		super(new DimensionOfMemberFunDef());
	}
