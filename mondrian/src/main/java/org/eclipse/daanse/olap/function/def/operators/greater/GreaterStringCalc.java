...
public class GreaterStringCalc extends AbstractProfilingNestedBooleanCalc {

    protected GreaterStringCalc(Type type, final StringCalc calc0, final StringCalc calc1) {
