...
public class FormatNumberFunDef  extends AbstractFunctionDefinition {


    public FormatNumberFunDef(FunctionMetaData functionMetaData) {
    ...
    public Calc<?> compileCall(ResolvedFunCall call, ExpressionCompiler compiler) {
        ...
        return new FormatNumberCalc(call.getType(), expressionCalc, numDigitsAfterDecimalCalc, includeLeadingDigitCalc, useParensForNegativeNumbersCalc, groupDigitsCalc);
    }
