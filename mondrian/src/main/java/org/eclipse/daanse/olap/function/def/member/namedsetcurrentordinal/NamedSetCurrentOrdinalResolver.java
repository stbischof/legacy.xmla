...
public class NamedSetCurrentOrdinalResolver extends ParametersCheckingFunctionDefinitionResolver {

    public NamedSetCurrentOrdinalResolver() {
        super(new NamedSetCurrentOrdinalFunDef());
    }
}
