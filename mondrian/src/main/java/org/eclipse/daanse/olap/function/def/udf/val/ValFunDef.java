...
public class ValFunDef  extends AbstractFunctionDefinition {
    ...
    public Calc<?> compileCall(ResolvedFunCall call, ExpressionCompiler compiler) {
        final DoubleCalc doubleCalc = compiler.compileDouble(call.getArg(0));
        return new ValCalc(call.getType(), doubleCalc);
