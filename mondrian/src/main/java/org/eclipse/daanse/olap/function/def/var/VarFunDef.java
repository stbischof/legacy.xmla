...
public class VarFunDef extends AbstractAggregateFunDef {

    public VarFunDef(FunctionMetaData functionMetaData) {
    ...
    public Calc<?> compileCall(ResolvedFunCall call, ExpressionCompiler compiler) {
        ...
        return new VarCalc(call.getType(), tupleListCalc, calc ) {
        };
    }
}
