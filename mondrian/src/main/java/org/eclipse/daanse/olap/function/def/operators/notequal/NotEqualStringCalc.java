...
public class NotEqualStringCalc extends AbstractProfilingNestedBooleanCalc {

    protected NotEqualStringCalc(Type type, final StringCalc calc0, final StringCalc calc1) {
