...
public class DimensionsStringResolver extends ParametersCheckingFunctionDefinitionResolver {

    public DimensionsStringResolver() {
        super(new DimensionsStringFunDef());
    }
