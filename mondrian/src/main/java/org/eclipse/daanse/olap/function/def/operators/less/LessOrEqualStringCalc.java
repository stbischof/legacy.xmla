...
public class LessOrEqualStringCalc extends AbstractProfilingNestedBooleanCalc {

    protected LessOrEqualStringCalc(Type type, final StringCalc calc0, final StringCalc calc1) {
