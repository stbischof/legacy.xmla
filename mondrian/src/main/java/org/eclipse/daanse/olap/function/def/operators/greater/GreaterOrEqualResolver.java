...
public class GreaterOrEqualResolver extends ParametersCheckingFunctionDefinitionResolver {
    public GreaterOrEqualResolver() {
        super(new GreaterOrEqualOperatorDef());
    }
}
