...
public class DimensionOfLevelResolver extends ParametersCheckingFunctionDefinitionResolver {

	public DimensionOfLevelResolver() {
		super(new DimensionOfLevelFunDef());
	}
