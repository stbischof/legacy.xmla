...
public class NotEqualStringResolver extends ParametersCheckingFunctionDefinitionResolver {
    public NotEqualStringResolver() {
        super(new NotEqualStringOperatorDef());
    }
}
