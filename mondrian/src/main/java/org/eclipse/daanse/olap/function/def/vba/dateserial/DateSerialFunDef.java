...
public class DateSerialFunDef  extends AbstractFunctionDefinition {
    ...
    public Calc<?> compileCall(ResolvedFunCall call, ExpressionCompiler compiler) {
        final IntegerCalc yearCalc = compiler.compileInteger(call.getArg(0));
        final IntegerCalc monthCalc = compiler.compileInteger(call.getArg(1));
        final IntegerCalc dayCalc = compiler.compileInteger(call.getArg(2));
        return new DateSerialCalc(call.getType(), yearCalc, monthCalc, dayCalc);
    }
