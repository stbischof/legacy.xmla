...
public class FirstSiblingFunDef extends AbstractFunctionDefinition {
    ...
    static FunctionMetaData functionMetaData = new FunctionMetaDataR(plainPropertyOperationAtom,
            "Returns the first child of the parent of a member.", "<MEMBER>.FirstSibling", DataType.MEMBER,
    ...
    public Calc<?> compileCall(ResolvedFunCall call, ExpressionCompiler compiler) {
        ...
        return new FirstSiblingCalc(call.getType(), memberCalc);
    }
}
