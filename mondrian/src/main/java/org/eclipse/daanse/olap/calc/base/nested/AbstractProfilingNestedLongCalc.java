 ...
 *
 */
public abstract class AbstractProfilingNestedLongCalc extends AbstractProfilingNestedCalc<Long>
		implements LongCalc {
	/**
	 * {@inheritDoc}
	 *
	 */
	protected AbstractProfilingNestedLongCalc(Type type, Calc<?>... calcs) {
		super(type, calcs);
