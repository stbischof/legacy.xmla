...
public class IifTupleCalc extends AbstractProfilingNestedUnknownCalc {

    private final BooleanCalc booleanCalc;
    private final Calc<?> calc1;
    private final Calc<?> calc2;

    protected IifTupleCalc(Type type, final BooleanCalc booleanCalc, final Calc<?> calc1, final Calc<?> calc2) {
        super(type);
