...
public class CalculatedChildResolver extends ParametersCheckingFunctionDefinitionResolver {
    public CalculatedChildResolver() {
        super(new CalculatedChildFunDef());
    }
}
