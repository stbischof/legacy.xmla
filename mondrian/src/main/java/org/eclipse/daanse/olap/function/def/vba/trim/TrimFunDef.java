...
public class TrimFunDef  extends AbstractFunctionDefinition {

    static FunctionOperationAtom atom = new FunctionOperationAtom("Trim");
    static String description = """
        Returns a Variant (String) containing a copy of a specified string
        without leading and trailing spaces.""";
    static String signature = "Trim(string)";
    ...
    public Calc<?> compileCall(ResolvedFunCall call, ExpressionCompiler compiler) {
        ...
        return new TrimCalc(call.getType(), stringCalc);
    }
