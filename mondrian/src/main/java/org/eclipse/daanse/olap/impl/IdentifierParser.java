...
public class IdentifierParser {
    ...
    public static void parseTupleList(
        IdentifierParser.Builder builder,
        String string)
    {
        int i = 0;
        char c;
        ...
        int i)
    {
        ...
        int state = START;
        int start = 0;
        IdentifierParser.Builder.Syntax syntax = IdentifierParser.Builder.Syntax.NAME;
        char c;
                ...
                case BEFORE_SEG:
                    switch (c) {
                        ...
                        case '&':
                            ...
                            syntax = IdentifierParser.Builder.Syntax.FIRST_KEY;
                            break;
                    ...
                    switch (c) {
                        ...
                        case '.':
                            builder.segmentComplete(
                                ...
                                Quoting.UNQUOTED,
                                syntax);
                            syntax = IdentifierParser.Builder.Syntax.NAME;
                            state = BEFORE_SEG;
                            ++i;
                            break;
                        case '&':
                            builder.segmentComplete(
                                ...
                                Quoting.UNQUOTED,
                                syntax);
                            syntax = IdentifierParser.Builder.Syntax.NEXT_KEY;
                            state = BEFORE_SEG;
                            ++i;
                            break;
                        default:
    ...
    public static List<IdentifierSegment> parseIdentifier(String s)  {
        final IdentifierParser.MemberBuilder builder = new IdentifierParser.MemberBuilder();
    ...
    public static List<List<IdentifierSegment>> parseIdentifierList(
        String s)
    {
        final IdentifierParser.MemberListBuilder builder = new IdentifierParser.MemberListBuilder();
    ...
    /**
     * Implementation of {@link IdentifierParser.Builder}
     ...
     */
    public static class MemberListBuilder extends IdentifierParser.MemberBuilder {
