...
public class NamedSetCurrentResolver extends ParametersCheckingFunctionDefinitionResolver {

    public NamedSetCurrentResolver() {
        super(new NamedSetCurrentFunDef());
    }
}
