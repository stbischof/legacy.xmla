...
public class DimensionNumericResolver extends ParametersCheckingFunctionDefinitionResolver {

	public DimensionNumericResolver() {
		super(new DimensionsNumericFunDef());
	}
