...
public class CurrentDateStringResolver extends ParametersCheckingFunctionDefinitionResolver {

    public CurrentDateStringResolver() {
        super(new CurrentDateStringFunDef());
    }
}
