    ...
    implements RolapMember
{
    ...
    public Member createPseudoLeafMember(Member child, String name) {
        RolapMember m =
                new RolapMemberBase(this, (((org.eclipse.daanse.rolap.common.RolapCubeMember)child).getRolapMember().getLevel()), this.getName(), name, MemberType.REGULAR);
        return new RolapPseudoLeafMember(
                (RolapCubeMember) this, m,
                ((org.eclipse.daanse.rolap.common.RolapCubeLevel)this.getLevel().getChildLevel()));
    }
